...
angles = re.compile(r"[+-]?\d+(?:\.\d+)?")
verti_angle = angles.findall(image_name)[1]
horiz_angle = angles.findall(image_name)[2]
...
print("Estimated [roll, pitch, yaw]:\n[" + str(roll[0,0,0]) + ", " + str(pitch[0,0,0]) + ", " + str(yaw[0,0,0])  + "]\n")